...
#define BUZZER_FREQUENCY_HZ 200       // Default 10000, 20Hz to 60KHz
...
#define PREHEAT_BED      {60,      75,       95}
#define PREHEAT_HOTEND   {210,     235,      245}

#define HEAT_MAX_TEMP    {130,    280,       275,       275,       275,       275,       275}    //max temperature can be set
#define HEAT_SIGN_ID     {"B:",   "T0:",     "T1:",     "T2:",     "T3:",     "T4:",     "T5:"}
#define HEAT_DISPLAY_ID  {" ",  " ",      "T1",      "T2",      "T3",      "T4",      "T5"}
...
#define NOZZLE_PAUSE_RETRACT_LENGTH 16   // (mm)
#define NOZZLE_RESUME_PURGE_LENGTH  19   // (mm)
