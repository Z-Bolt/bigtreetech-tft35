...
#define _LANGUAGE_RU_H_
    ...
    #define RU_SIMULATOR_BG_COLOR     "Marlin simulator background color"
    #define RU_SIMULATOR_FONT_COLOR   "Marlin simulator font color"
    ...
    #define RU_UNCONNECTED            "Идет подключение..."
