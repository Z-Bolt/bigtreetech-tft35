...
#define _LANGUAGE_IT_H_
    ...
    #define IT_SIMULATOR_BG_COLOR     "Marlin simulator background color"
    #define IT_SIMULATOR_FONT_COLOR   "Marlin simulator font color"
    ...
    #define IT_CONFIRM_LOAD           "Confirm load"
    #define IT_CONFIRM_UNLOAD         "Confirm unload"
    #define IT_WAIT_HEAT              "Heating, wait..."
#endif
