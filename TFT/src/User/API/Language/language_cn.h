...
#define _LANGUAGE_CN_H_
    ...
    #define CN_STATUS                 "状态"
    #define CN_SIMULATOR_BG_COLOR     "Marlin模式背景颜色"
    #define CN_SIMULATOR_FONT_COLOR   "Marlin模式字体颜色"
    #define CN_WHITE                  "白色"
    #define CN_BLACK                  "黑色"
    #define CN_BLUE                   "蓝色"
    #define CN_RED                    "红色"
    ...
    #define CN_ORANGE                 "橙色"
    #define CN_INDIGO                 "靛"
    #define CN_VIOLET                 "紫罗兰色"
    #define CN_MAGENTA                "桃红色"
    #define CN_PURPLE                 "紫色"
    #define CN_LIME                   "青柠色"
    #define CN_DARKBLUE               "暗蓝色"
    #define CN_DARKGREEN              "暗绿色"
    #define CN_DARKGRAY               "暗灰色"
    #define CN_DISCONNECT             "断开连接"
    #define CN_BAUDRATE               "波特率"
    ...
    #define CN_SEND_CANCEL_GCODE      "中断打印Gcode"
